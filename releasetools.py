...
def FullOTA_InstallEnd(info):
	...
	info.script.AppendExtra('delete_recursive("/system/xt897");')
	info.script.AppendExtra('ifelse(is_substring("240", getprop("ro.sf.lcd_density")), run_program("/sbin/sh", "-c", "busybox mv /system/media/480.zip /system/media/bootanimation.zip"));')
	...
	info.script.AppendExtra('delete_recursive("/system/xt901");')
